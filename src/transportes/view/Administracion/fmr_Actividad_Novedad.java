 ...
 * @author Developer
 */
public class fmr_Actividad_Novedad extends JPanel {
    
    public fmr_Actividad_Novedad() {
        initComponents();
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                fmr_Actividad_Novedad.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                fmr_Actividad_Novedad.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                fmr_Actividad_Novedad.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                fmr_Actividad_Novedad.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<transportes.JPA.ActividadNovedad> toRemove = new ArrayList<transportes.JPA.ActividadNovedad>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            transportes.JPA.ActividadNovedad a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        transportes.JPA.ActividadNovedad a = new transportes.JPA.ActividadNovedad();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<transportes.JPA.ActividadNovedad> merged = new ArrayList<transportes.JPA.ActividadNovedad>(list.size());
            for (transportes.JPA.ActividadNovedad a : list) {
    ...
    private java.util.List<transportes.JPA.ActividadNovedad> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fmr_Actividad_Novedad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new fmr_Actividad_Novedad());
