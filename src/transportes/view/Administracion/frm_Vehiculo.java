...
public class frm_Vehiculo extends JPanel {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(transportes.JPA.TipoVehiculo.class);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lineaField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(modeloField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(idTipoVehiculoField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<transportes.JPA.Vehiculo> toRemove = new ArrayList<transportes.JPA.Vehiculo>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            transportes.JPA.Vehiculo v = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(v);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        transportes.JPA.Vehiculo v = new transportes.JPA.Vehiculo();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<transportes.JPA.Vehiculo> merged = new ArrayList<transportes.JPA.Vehiculo>(list.size());
            for (transportes.JPA.Vehiculo v : list) {
    ...
    private java.util.List<transportes.JPA.Vehiculo> list;
