...
public class frm_Tipo_Vehiculo extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<transportes.JPA.TipoVehiculo> toRemove = new ArrayList<transportes.JPA.TipoVehiculo>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            transportes.JPA.TipoVehiculo t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        transportes.JPA.TipoVehiculo t = new transportes.JPA.TipoVehiculo();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<transportes.JPA.TipoVehiculo> merged = new ArrayList<transportes.JPA.TipoVehiculo>(list.size());
            for (transportes.JPA.TipoVehiculo t : list) {
    ...
    private java.util.List<transportes.JPA.TipoVehiculo> list;
