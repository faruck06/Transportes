...
public class frm_Proyecto extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<transportes.JPA.Proyecto> toRemove = new ArrayList<transportes.JPA.Proyecto>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            transportes.JPA.Proyecto p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        transportes.JPA.Proyecto p = new transportes.JPA.Proyecto();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<transportes.JPA.Proyecto> merged = new ArrayList<transportes.JPA.Proyecto>(list.size());
            for (transportes.JPA.Proyecto p : list) {
    ...
    private java.util.List<transportes.JPA.Proyecto> list;
