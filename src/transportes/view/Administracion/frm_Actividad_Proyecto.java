 ...
 */
package transportes.view.Administracion;
 ...
 * @author Developer
 */
public class frm_Actividad_Proyecto extends JPanel {
    
    public frm_Actividad_Proyecto() {
        initComponents();
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("transportes?zeroDateTimeBehavior=convertToNullPU").createEntityManager();
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                frm_Actividad_Proyecto.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                frm_Actividad_Proyecto.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                frm_Actividad_Proyecto.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                frm_Actividad_Proyecto.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<transportes.JPA.ActividadPrincipal> toRemove = new ArrayList<transportes.JPA.ActividadPrincipal>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            transportes.JPA.ActividadPrincipal a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        transportes.JPA.ActividadPrincipal a = new transportes.JPA.ActividadPrincipal();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<transportes.JPA.ActividadPrincipal> merged = new ArrayList<transportes.JPA.ActividadPrincipal>(list.size());
            for (transportes.JPA.ActividadPrincipal a : list) {
    ...
    private java.util.List<transportes.JPA.ActividadPrincipal> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Actividad_Proyecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new frm_Actividad_Proyecto());
