...
public class Frm_Usuario_Proyecto extends JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Usuario Proyecto ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(masterScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 1030, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(nombreField, javax.swing.GroupLayout.DEFAULT_SIZE, 985, Short.MAX_VALUE)
                            .addComponent(tipoField, javax.swing.GroupLayout.DEFAULT_SIZE, 985, Short.MAX_VALUE))))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(432, 432, 432)
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<transportes.JPA.UsuarioProyecto> toRemove = new ArrayList<transportes.JPA.UsuarioProyecto>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            transportes.JPA.UsuarioProyecto u = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(u);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        transportes.JPA.UsuarioProyecto u = new transportes.JPA.UsuarioProyecto();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<transportes.JPA.UsuarioProyecto> merged = new ArrayList<transportes.JPA.UsuarioProyecto>(list.size());
            for (transportes.JPA.UsuarioProyecto u : list) {
    ...
    private java.util.List<transportes.JPA.UsuarioProyecto> list;
