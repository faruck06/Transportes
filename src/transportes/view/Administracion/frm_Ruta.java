...
public class frm_Ruta extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT r FROM Ruta r");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<transportes.JPA.Ruta> toRemove = new ArrayList<transportes.JPA.Ruta>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            transportes.JPA.Ruta r = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(r);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        transportes.JPA.Ruta r = new transportes.JPA.Ruta();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<transportes.JPA.Ruta> merged = new ArrayList<transportes.JPA.Ruta>(list.size());
            for (transportes.JPA.Ruta r : list) {
    ...
    private java.util.List<transportes.JPA.Ruta> list;
